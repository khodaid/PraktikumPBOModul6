...
public class KamusView extends ComponentView {
    ...
    public KamusView() {
        ...
        jtxtKata.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (jrIndoToIng.isSelected()) {
                    jtxtDetail.setText(Controller.CekIndo(jtxtKata.getText().toLowerCase()));
                }
                else if(jrIngToIndo.isSelected())
                {
                    jtxtDetail.setText(Controller.CekIng(jtxtKata.getText().toLowerCase()));
                }
            }
        });
